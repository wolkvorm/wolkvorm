...
variable "subnet_group_name" { type = string; default = null }
...
variable "replicas_per_node_group" { type = number; default = 0 }
variable "at_rest_encryption_enabled" { type = bool; default = true }
variable "transit_encryption_enabled" { type = bool; default = false }
variable "apply_immediately" { type = bool; default = false }
variable "snapshot_retention_limit" { type = number; default = 1 }
