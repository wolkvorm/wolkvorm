...
variable "launch_template_name" { type = string; default = null }
...
variable "health_check_grace_period" { type = number; default = 300 }
variable "default_cooldown" { type = number; default = 300 }
variable "target_group_arns" { type = list(string); default = [] }
variable "protect_from_scale_in" { type = bool; default = false }
