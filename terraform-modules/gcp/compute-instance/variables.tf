...
variable "boot_disk_image" { type = string; default = "debian-cloud/debian-12" }
...
variable "external_ip" { type = bool; default = true }
variable "tags" { type = list(string); default = [] }
variable "metadata" { type = map(string); default = {} }
variable "metadata_startup_script" { type = string; default = null }
variable "service_account_email" { type = string; default = null }
variable "service_account_scopes" { type = list(string); default = ["cloud-platform"] }
