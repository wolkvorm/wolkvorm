...
variable "encryption_type" { type = string; default = "AES256" }
variable "kms_key" { type = string; default = null }
variable "lifecycle_policy" { type = string; default = null }
variable "repository_policy" { type = string; default = null }
