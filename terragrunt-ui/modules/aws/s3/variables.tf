variable "bucket" { type = string; default = null }
variable "bucket_prefix" { type = string; default = null }
variable "force_destroy" { type = bool; default = false }
variable "versioning_enabled" { type = bool; default = false }
variable "server_side_encryption_configuration" { type = bool; default = true }
...
variable "object_ownership" { type = string; default = "BucketOwnerPreferred" }
variable "lifecycle_rule_enabled" { type = bool; default = false }
